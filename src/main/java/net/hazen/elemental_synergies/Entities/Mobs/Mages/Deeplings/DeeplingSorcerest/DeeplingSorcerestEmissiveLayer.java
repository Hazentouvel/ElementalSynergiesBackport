...
public class DeeplingSorcerestEmissiveLayer extends GeoRenderLayer<AbstractSpellCastingMob> {
    public DeeplingSorcerestEmissiveLayer(GeoRenderer<AbstractSpellCastingMob> entityRenderer) {
    ...
    public void render(PoseStack poseStack, AbstractSpellCastingMob animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ResourceLocation layerTex = ResourceLocation.fromNamespaceAndPath("elemental_synergies", "textures/entities/mobs/deepling_sorcerest_layer.png");
