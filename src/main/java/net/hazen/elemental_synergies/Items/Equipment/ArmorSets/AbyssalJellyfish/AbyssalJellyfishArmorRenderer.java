...
public class AbyssalJellyfishArmorRenderer extends GeoArmorRenderer<AbyssalJellyfishArmorItem> {
    public AbyssalJellyfishArmorRenderer(AbyssalJellyfishArmorModel abyssalJellyfishArmorModel) {
        super(new AbyssalJellyfishArmorModel());
        this.addRenderLayer(new AbyssalJellyfishArmorLayer(this));
    ...
    public RenderType getRenderType(AbyssalJellyfishArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
