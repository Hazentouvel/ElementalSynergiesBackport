...
public class ExoMechSuitArmorRenderer extends GeoArmorRenderer<ExoMechSuitArmorItem> {
    public ExoMechSuitArmorRenderer(ExoMechSuitArmorModel exoMechSuitArmorModel) {
        super(new ExoMechSuitArmorModel());
        this.addRenderLayer(new ExoMechSuitArmorLayer(this));
    ...
    public RenderType getRenderType(ExoMechSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
