...
public class FreddyFazbearArmorRenderer extends GeoArmorRenderer<FreddyFazbearArmorItem> {
    public FreddyFazbearArmorRenderer(FreddyFazbearArmorModel freddyFazbearArmorModel) {
        super(new FreddyFazbearArmorModel());
        this.addRenderLayer(new FreddyFazbearArmorLayer(this));
    ...
    public RenderType getRenderType(FreddyFazbearArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
